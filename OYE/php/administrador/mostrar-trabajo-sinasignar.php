			...
			<?php 
				if (isset($_POST['enviar'])) {
					...
					if (empty($ids_operario)) {
						echo "<div class='alert alert-warning'>Debes elegir al menos un/a trabajador/a</div>";
					}else{
						...
						echo "<div class='alert alert-success'>Los trabajadores <b>han sido asignados</b> correctamente</div>";
