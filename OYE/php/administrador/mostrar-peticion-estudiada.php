<?php 
	...
	function mostrarPeticion(){
		...
		$info = array("$titulo", "$descripcion", "$tipo", "$fecha", "$ruta_img", "$nombre", "$apellidos", "$estado", "$detalles");
		...
		<div class="acciones">
			...
			<form action="#" method="POST">
				<div class="caja">
					...
					?>
		              <label class="concheck">Aceptar
		                <input id="aceptar" type="radio" class="acep" name="res" checked value="aceptada" data-toggle="collapse" data-target="#collapseText" checked required>
					...
					?>
					  <label class="concheck">Aceptar
		                <input id="aceptar" type="radio" class="acep" name="res" checked value="aceptada" data-toggle="collapse" data-target="#collapseText" required>
		                <span class="checkmark"></span>
		              </label>
		              <label class="concheck">Rechazar
		                <input id="rechazar" type="radio" class="rech" name="res" value="rechazada" data-toggle="collapse" data-target="#collapseText" checked required>
		                <span class="checkmark"></span>
		              </label>
		            <?php } ?>
		            </div>
				...
				<div class="detalles collapse" id="collapseText">
					<textarea id="txtArea" name="textarea"><?php echo $detalles; ?></textarea>
					<script>
		...
		<?php 
			...
			if (isset($_POST['confirmar'])) {
				...
				if ($resolucion == 'aceptada') {
					$instancia = "UPDATE denuncia SET estado = 'Aceptada', detalles = '' WHERE id = $id";
